function main () {
   logseq.provideStyle(`
   /*===========================================================*/
   /* WIP css eisenhower matrix by cannibalox v20220307 --------*/
   ...
   /*==== logseq-bars v20210307 start ====== */
      ...
      [data-ref*="bar-"]:before{
         ...
         [data-ref*="flatbar-"]:before {background:red;}
         [data-ref*="bar-00"]:before {width: 1px;}
         [data-ref*="bar-10"]:before {width: 10px;}
         [data-ref*="bar-20"]:before {width: 20px;}
         [data-ref*="bar-30"]:before {width: 30px;}
         [data-ref*="bar-40"]:before {width: 40px;}
         [data-ref*="bar-50"]:before {width: 50px;}        
         [data-ref*="bar-60"]:before {width: 60px;}
         [data-ref*="bar-70"]:before {width: 70px;}
         [data-ref*="bar-80"]:before {width: 80px;}
         [data-ref*="bar-90"]:before {width: 90px;}
         [data-ref*="bar-100"]:before {width: 100px;}
